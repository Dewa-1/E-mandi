...
<script>
// import NavbarIt from '@/components/NavbarIt.vue'
import NavbarIt from '@/components/NavbarIt'
import CategoryIt from '@/components/CategoryIt'
import ProductIt from '@/components/ProductIt'
import PackIt from '@/components/PackIt'
import ClientIt from '@/components/ClientIt'
import PartnerIt from '@/components/PartnerIt'
